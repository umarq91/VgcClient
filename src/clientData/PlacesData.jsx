...
const  PlacesData=[
    {title:"Wisal Garden",img:img1,name:"wisal-garden",type:'Residential',location:"Peshawar"},
    {title:"Vision Enclave",img:img2,name:'vision-enclave',type:'Housing Area'},
    {title:"Orchard Square",img:'/darmangi.jpg',name:'orchard-square',type:'Residential'},
