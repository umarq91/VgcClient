...
&& PlacesData.map((product) => (
  ...
  <div className='bg-blue-500 h-[65vh] w-96  relative hover:bg-red-500 cursor-pointer  shadow-md rounded-3xl overflow-hidden transition ease-in-out hover:-translate-y-3'>
