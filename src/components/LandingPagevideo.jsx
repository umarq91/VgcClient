...
const LandingPagevideo = () => {
  ...
  return (
    ...
    viewport={{ once: true }} transition={{ duration: 3, type: "spring" }}>
      <div className="relative h-auto min-h-[250px]  max-w-[100vw]  flex justify-center items-center">
        {isVideoPlaying ? (
          //  Video and layout div
          <>
            <video
              autoPlay muted onPlay={() => setIsVideoPlaying(true)}  loop
              className="h-auto min-h-[400px] w-auto object-cover -z-1"
          ...
          <div className="text-center h-[100vh] bg-black flex justify-center items-center">
            <div role="status">
              <svg
                aria-hidden="true"
                class="w-12 h-12 ml-6 text-gray-200 animate-spin text-center dark:text-gray-600 fill-blue-600"
                viewBox="0 0 100 101"
                fill="none"
