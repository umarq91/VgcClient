...
const AboutUsNew = () => {
  ...
  return (
    <div className='bg-gray-200 shadow-lg drop-shadow-2xl'>
      ...
      {/* About Us */}
      <h1 className="font-light text-5xl text-center mt-4 text-gray-700 tracking-[2px] underline decoration-red-500 font-lora">
        {" "}
...
{/* CEO  */}
 <div className="px-12 lg:flex md:flex lg:items-center lg:px-16 xl:px-16 xl:mx-auto gap-[30px] mt-10">
    ...
    <div className="px-4 flex flex-col mx-auto w-100  max-w-[80%] tracking-[2px] md:max-w-[60%] lg:max-w-[50%]   items-center    gap-[30px]">
        {/* Intro */}
        <div className="">
