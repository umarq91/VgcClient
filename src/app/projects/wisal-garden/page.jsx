    ...
    <>
      ...
      <div className=" h-[300px] xl:h-[500px] md:h-[450px] w-full relative">
        ...
        <div className="flex flex-col items-center justify-center h-full relative">
          ...
          <h2 className="text-center text-white text-5xl font-bold font-inconsolata tracking-[4px] underline decoration-orange-800">
            {" "}
            WISAL GARDEN
          </h2>
        </div>
      ...
      {/*  */}
      <div className="mx-8 mx-auto max-w-[100vw]">
        <div>
          <h1 className='font-light text-3xl md:text-4xl lg:text-5xl xl:text-5xl mt-16 text-center mt-4 text-gray-700 tracking-[2px] underline decoration-orange-500/80 mb-8 '> About Wisal Garden </h1>
          <video
        ...
        {/* Content */}
        <div className="mt-5 mx-5 md:w-1/2 lg:1/2 items-center">
          ...
          {/* <h2 className="text-3xl text-gray-800 text-center font-bold font-lora tracking-[2px]">
           ...
           <Link  href='https://www.google.com/maps/dir//3PC7%2B5C6+Wisal+Gardens,+Peshawar,+Khyber+Pakhtunkhwa+25000/@34.0301642,71.461499,11z/data=!4m8!4m7!1m0!1m5!1m1!1s0x38d93b9eed3069f7:0x800cbd8e81615354!2m2!1d71.7135111!2d34.0703789?entry=ttu' className=' flex items-center justify-center'>
            
      <button className='text-white text-lg flex bg-blue-800 hover:bg-gray-500 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-sm px-7 py-2.5  dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700'> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
